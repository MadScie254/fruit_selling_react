...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-green-50 text-gray-800 font-sans">
              ...
              {cart.length > 0 ? (
                <>
                  <ul className="space-y-4 mb-6">
                    {cart.map((item, index) => (
                      <li key={index} className="flex justify-between items-center bg-gray-50 p-4 rounded-xl hover:bg-gray-100 transition-colors">
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-gray-600 text-sm font-semibold">{formatCurrency(item.price)}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3 bg-white rounded-lg p-1 border border-gray-200">
                          <button
                            onClick={() => updateQuantity(item.id, -1)}
                            className="text-gray-600 hover:text-red-500 font-bold w-8 h-8 rounded hover:bg-red-50 transition-all"
                          >
                            −
                          </button>
                          ...
                          <button
                            onClick={() => updateQuantity(item.id, 1)}
                            className="text-gray-600 hover:text-green-500 font-bold w-8 h-8 rounded hover:bg-green-50 transition-all"
                          >
                            +
                          </button>
                        </div>
                        <button
                          ...
                          className="text-gray-400 hover:text-red-500 ml-2 font-bold text-xl hover:bg-red-50 w-8 h-8 rounded flex items-center justify-center transition-all"
                        >
                          ✕
                        </button>
                      </li>
                  ...
                  <div className="border-t-2 border-gray-200 pt-6 space-y-4">
                    ...
                    <div className="bg-gradient-light p-4 rounded-xl">
                      <h4 className="font-bold mb-3 text-gray-800">📦 Delivery</h4>
                      <div className="space-y-2">
                        <label className="flex items-center cursor-pointer">
                          <input type="radio" name="delivery" defaultChecked className="w-4 h-4" />
                          <span className="ml-2 text-sm">Standard (3-5 days) - Free</span>
                        </label>
                        <label className="flex items-center cursor-pointer">
                          <input type="radio" name="delivery" className="w-4 h-4" />
                          <span className="ml-2 text-sm">Express (1-2 days) - {formatCurrency(50)}</span>
                        </label>
                      </div>
                    </div>
                    <div className="bg-blue-50 p-4 rounded-xl">
                      <h4 className="font-bold mb-3 text-gray-800">💳 Payment</h4>
                      <div className="space-y-2">
                        <label className="flex items-center cursor-pointer">
                          <input type="radio" name="payment" defaultChecked className="w-4 h-4" />
                          <span className="ml-2 text-sm">📱 M-Pesa</span>
                        </label>
                        <label className="flex items-center cursor-pointer">
                    ...
                    <button className="w-full btn-primary shadow-lg hover:shadow-xl">
                      Proceed to Checkout
                    </button>
                    <p className="text-xs text-gray-500 text-center">
                      ✅ Your order will be packed & shipped within 24 hours
                    </p>
                  </div>
                </>
              ) : (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg font-semibold mb-4">Your cart is empty</p>
                  <button
                    onClick={() => setIsCartOpen(false)}
      ...
      {/* Footer */}
      <footer id="contact" className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 mt-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            <div className="space-y-3">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-3xl">🍎</span>
                <h3 className="text-2xl font-bold">FruitMart</h3>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">
                We bring you the freshest fruits from local farms across East Africa. Quality assured, fresh guaranteed!
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#products" className="text-gray-400 hover:text-green-400 transition-colors">🛍️ Products</a></li>
                <li><a href="#" onClick={() => setShowAboutUs(true)} className="text-gray-400 hover:text-green-400 transition-colors">ℹ️ About Us</a></li>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-2">📧 <a href="mailto:dmwanjala254@gmail.com" className="hover:text-green-400 transition-colors">dmwanjala254@gmail.com</a></p>
              <p className="text-gray-400 text-sm mb-2">📱 <a href="tel:+254742007277" className="hover:text-green-400 transition-colors">+254 742 007 277</a></p>
              <p className="text-gray-400 text-sm">📍 Nairobi, Kenya</p>
            </div>
            <div>
              <h4 className="text-xl font-bold mb-4 text-green-400">Follow Us</h4>
              <div className="flex gap-4">
                <a href="#" className="text-gray-400 hover:text-green-400 hover:scale-125 transition-all transform">
          ...
          <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
            <p>🏪 &copy; 2025 FruitMart. All rights reserved. Bringing freshness to your table.</p>
          </div>
        </div>
      </footer>
    </div>
